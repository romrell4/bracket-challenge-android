...
open class UserBracketFragment: BracketFragment() {
	...
	override fun getTextColor(playerId: Int?, predictionId: Int?, winnerId: Int?) = ContextCompat.getColor(requireActivity(),
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
		...
		if (arguments?.containsKey(BRACKET_EXTRA) == true) {
